...
function Contact() {
    ...
    async function handleSend(event) {
        event.preventDefault(); // Prevent the dafault form submission

        console.log("Form submitted"); // test to see if the function being called before the logic
    ...
    // this allows us to use a simgl function to handle change for all fields
